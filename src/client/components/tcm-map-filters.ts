...
import './tcm-map-filter-button.ts';

@customElement('tcm-map-filters')
export default class TcmMapFilters extends TwElement {
	render() {
		return html`
			<div>
				<!--
								...
								<div class="flow-root">
									<div class="-mx-4 flex items-center divide-x divide-gray-200">
										<div class="relative inline-block px-4 text-left">
											<tcm-map-filter-button></tcm-map-filter-button>
